...
class FiveToOneClient:
    ...
    def orchestrate(
        ...
        run_id = run_id or os.environ.get("TRACIFY_CURRENT_RUN_ID") or os.environ.get("FIVETOONE_CURRENT_RUN_ID") or str(uuid.uuid4())
...
def llm_call(input_data: Any, output_data: Any, model_id: str, cost_usd: float, latency_ms: int, client: Optional[FiveToOneClient] = None, session_id: Optional[str] = None, end_user_id: Optional[str] = None, environment: Optional[str] = None, release: Optional[str] = None, tags: Optional[List[str]] = None, trace_name: Optional[str] = None):
...
def tool_call(tool_name: str, input_data: Any, output_data: Any, latency_ms: int, client: Optional[FiveToOneClient] = None, session_id: Optional[str] = None, end_user_id: Optional[str] = None, environment: Optional[str] = None, release: Optional[str] = None, tags: Optional[List[str]] = None, trace_name: Optional[str] = None):
    if client is None: client = FiveToOneClient()
    client.ingest(
        runId=os.environ.get("TRACIFY_CURRENT_RUN_ID") or os.environ.get("FIVETOONE_CURRENT_RUN_ID", "unknown"),
        spanType="tool_call",
