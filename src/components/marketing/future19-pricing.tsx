...
const plans = [
  {
    ...
    monthly: "$0",
    annual: "$0",
    features: ["50k spans", "7-day retention", "1 project / 1 member"],
    featured: false,
  },
  {
    name: "Pro",
    monthly: "$19",
    annual: "$15.20",
    features: ["500k spans", "30-day retention", "3 projects / 5 members"],
    featured: true,
  },
  {
    name: "Team",
    monthly: "$39",
    annual: "$31.20",
    features: ["2m spans", "90-day retention", "Unlimited projects / 20 members"],
    featured: false,
  },
] as const;
