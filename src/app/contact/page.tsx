    ...
    <div className="min-h-screen bg-[#050505] text-white">
      <main className="mx-auto max-w-3xl px-6 pb-24 pt-32">
        ...
        <h1 className="mt-5 font-pixel text-4xl leading-tight md:text-6xl">
          Bring your agent operations into focus.
        </h1>
        <p className="mt-6 max-w-2xl font-sans text-lg leading-relaxed text-zinc-400">
          For enterprise deployment, design-partner access, migration support,
          or product questions, send us your team, stack, and the workflow you
        ...
        <div className="mt-12 border border-zinc-800 bg-[#0a0a0a] p-8">
          ...
          <a
            href="mailto:hello@tracify.tech"
            className="mt-3 inline-block font-mono text-xl text-white underline underline-offset-8 decoration-zinc-600 hover:decoration-white"
          >
            hello@tracify.tech
          </a>
