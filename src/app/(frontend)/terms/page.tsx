  ...
  return (
    <div className="min-h-screen bg-[#eceae3] pt-[54px] text-black selection:bg-yellow-300/40">
      <main className="mx-auto max-w-[1240px] border-x border-black">
        <header className="relative overflow-hidden border-b border-black bg-black px-6 py-16 text-white md:px-10 md:py-24"><div className="absolute -right-8 -top-16 rotate-12 border-4 border-[#f4d44d] px-8 py-4 font-mono text-2xl uppercase tracking-[0.15em] text-[#f4d44d] opacity-60">Agreement</div><p className="font-mono text-[9px] uppercase tracking-[0.16em] text-[#f4d44d]">Terms / effective 16.05.26</p><h1 className="mt-20 max-w-5xl font-pixel text-[clamp(4rem,10vw,9rem)] leading-[0.75] tracking-[-0.08em]">The rules of the working relationship.</h1><div className="mt-16 flex flex-wrap gap-x-10 gap-y-3 border-t border-white/20 pt-5 font-mono text-[8px] uppercase tracking-[0.13em] text-white/45"><span>Use</span><span>Limits</span><span>Billing</span><span>Responsibility</span><span>Jurisdiction</span></div></header>
