...
function ProductHero({ page, index }: { page: FeaturePage; index: number }) {
  ...
  const tone = page.visual === "failures" || page.visual === "models" ? "bg-[#00063D] text-white" : page.visual === "cost" || page.visual === "lifecycle" ? "bg-[#FA4028] text-black" : "bg-[#FFFFFF] text-black";
