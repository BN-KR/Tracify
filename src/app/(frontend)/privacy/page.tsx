    ...
    <div className="min-h-screen bg-[#eceae3] pt-[54px] text-black selection:bg-yellow-300/40">
      <main className="mx-auto max-w-[1240px] border-x border-black">
        <header className="grid border-b border-black md:grid-cols-[220px_1fr]">
          <div className="flex min-h-56 items-center justify-center bg-black text-[#f4d44d] md:min-h-[460px]"><span className="font-pixel text-[11rem] leading-none" aria-hidden="true">◉</span></div>
          <div className="flex flex-col justify-between border-t border-black px-6 py-12 md:border-l md:border-t-0 md:px-10 md:py-16"><div className="flex justify-between font-mono text-[8px] uppercase tracking-[0.15em] text-black/45"><span>Data handling record</span><span>16.05.26</span></div><h1 className="my-16 font-pixel text-[clamp(4rem,9vw,8rem)] leading-[0.78] tracking-[-0.075em]">What enters. What stays. What leaves.</h1><p className="max-w-xl text-base leading-7 text-black/56">The privacy policy, arranged around the lifecycle of information rather than a wall of legal prose.</p></div>
        </header>
