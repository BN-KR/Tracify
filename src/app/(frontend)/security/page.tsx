  ...
  return (
    <div className="min-h-screen bg-[#eceae3] pt-[54px] text-black selection:bg-yellow-300/40">
      <main className="mx-auto max-w-[1240px] border-x border-black">
        <header className="grid border-b border-black bg-[#f4d44d] md:grid-cols-[1fr_420px]"><div className="flex min-h-[500px] flex-col justify-between px-6 py-12 md:px-10 md:py-16"><div className="flex items-center justify-between font-mono text-[9px] uppercase tracking-[0.15em]"><span>Security control room</span><span>Trust / 01</span></div><h1 className="font-pixel text-[clamp(5rem,12vw,11rem)] leading-[0.72] tracking-[-0.09em]">Trust is a system.</h1><p className="max-w-xl text-base leading-7 text-black/60">How data is isolated, encrypted, governed, and investigated across the Tracify operating record.</p></div><div className="relative flex min-h-96 items-center justify-center overflow-hidden border-t border-black bg-black md:border-l md:border-t-0"><div className="absolute size-80 rounded-full border border-white/20"/><div className="absolute size-60 rounded-full border border-white/20"/><div className="absolute size-40 rounded-full border border-[#f4d44d]"/><div className="z-10 flex size-24 rotate-45 items-center justify-center bg-[#f4d44d]"><span className="-rotate-45 font-mono text-[9px] uppercase tracking-[0.12em]">Verified<br/>layers</span></div></div></header>
