...
export default function DocsRootPage() {
  return <FuturePage>
    <header className="border-b border-black"><div className="mx-auto max-w-[1240px] border-x border-black"><div className="grid lg:grid-cols-[1fr_1fr]">
      <div className="flex min-h-[540px] flex-col justify-between px-5 py-12 sm:px-8 md:px-10 md:py-16"><div className="flex items-center gap-3 font-mono text-[9px] uppercase tracking-[0.15em]"><span className="size-2 bg-[#f4d44d]"/>Developer field manual</div><h1 className="font-pixel text-[clamp(4rem,9vw,8rem)] leading-[0.78] tracking-[-0.075em]">Read.<br/>Run.<br/>Verify.</h1><p className="max-w-lg text-base leading-7 text-black/56">Instrument agents, inspect the execution record, and turn findings into safer releases.</p></div>
