    ...
    <header className="border-b border-black">
      <div className="mx-auto max-w-[1240px] border-x border-black">
        <div className="grid md:grid-cols-[1fr_1fr]">
          <div className="flex min-h-[480px] flex-col justify-between bg-black p-6 text-white md:p-10"><div className="flex justify-between font-mono text-[8px] uppercase tracking-[0.14em] text-white/40"><span>Release tape</span><span>Rolling</span></div><h1 className="font-pixel text-[clamp(4rem,9vw,8rem)] leading-[0.78] tracking-[-0.075em]">What changed?</h1><p className="max-w-md text-sm leading-6 text-white/50">A chronological record of meaningful product movement. No confetti, no inflated patch notes.</p></div>
          <div className="relative flex min-h-[480px] items-center justify-center overflow-hidden border-t border-black bg-[#f4d44d] md:border-l md:border-t-0"><div className="absolute inset-y-0 left-1/2 border-l border-black"/><div className="z-10 flex size-72 rotate-[-8deg] flex-col justify-between border-2 border-black bg-[#eceae3] p-7 shadow-[14px_14px_0_#000]"><span className="font-mono text-[8px] uppercase tracking-[0.14em]">Latest registered</span><strong className="font-pixel text-8xl tracking-[-0.08em]">26.08</strong><span className="border-t border-black pt-3 font-mono text-[9px] uppercase tracking-[0.12em]">System release</span></div></div>
        </div>
      </div>
    </header>
