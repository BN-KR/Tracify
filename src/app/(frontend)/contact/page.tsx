      ...
      <header className="border-b border-black bg-[#f4d44d]">
        <div className="mx-auto max-w-[1240px] border-x border-black">
          ...
          <div className="grid md:grid-cols-[1fr_220px]">
            <div className="px-5 py-10 sm:px-8 md:px-10 md:py-12"><h1 className="max-w-3xl font-pixel text-[clamp(3rem,6vw,5.5rem)] leading-[0.88] tracking-[-0.055em]">Bring the messy agent.</h1><p className="mt-6 max-w-2xl text-base leading-7 text-black/68">Send the stack, the failure mode, and the release decision your team cannot make yet.</p></div>
