      ...
      <header className="border-b border-black bg-[#f4d44d]">
        <div className="mx-auto max-w-[1240px] border-x border-black">
          ...
          <div className="grid md:grid-cols-[1fr_220px]">
            <div className="px-5 py-14 sm:px-8 md:px-10 md:py-20"><h1 className="font-pixel text-[clamp(4rem,10vw,9.5rem)] leading-[0.75] tracking-[-0.08em]">Bring the messy agent.</h1><p className="mt-10 max-w-2xl text-lg leading-7 text-black/60">Send the stack, the failure mode, and the release decision your team cannot make yet.</p></div>
