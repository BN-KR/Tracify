  ...
  return (
    <div className="captured-workspace" data-workspace-mode={workspace.mode} data-hydrated={hydrated ? "true" : "false"}>
      ...
      {surface === "home" ? (
        ...
        <EvaluatorsSurface workspace={workspace} onReadOnly={handleAction} onCreate={onEvaluatorCreate} onToggle={onEvaluatorToggle} />
      ) : surface === "datasets" ? (
...
function EvaluatorsSurface({ workspace, onReadOnly, onCreate, onToggle }: { workspace: DashboardWorkspace; onReadOnly: (action: string) => void; onCreate?: (input: { name: string; type: "code" | "llm_judge"; criteria: string }) => Promise<void>; onToggle?: (input: { evaluatorId: string; active: boolean }) => Promise<void> }) {
