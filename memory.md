...
- Committed the implementation as `43e670a` plus the previously untracked in-scope live adapters/detail route as `45b5e25`; unrelated scratch/archive files remain untracked and untouched.
